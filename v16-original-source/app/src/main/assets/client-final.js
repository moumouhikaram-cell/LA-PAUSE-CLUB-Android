'use strict';
/* LA PAUSE OS — final client runtime. No developer-facing UI. */
(function(){
const CLIENT_VERSION='2.1-client-polish';
const PREMIUM_VIEWS=new Set(['veDashboard','dashboard','veStations','veOverview','veBilliards','veSetup']);
const DEV_VIEWS=new Set(['osHome','osCoverage','osSaasHub','osCloud','osHQ','osOwner','osBilling','osOnboarding','osNetwork','osAI','osMedia','osTrust','osDevices','osProfit','systemStatus','osUniverse']);
const history=[];
let lastView=typeof currentView==='string'?currentView:'veDashboard';
