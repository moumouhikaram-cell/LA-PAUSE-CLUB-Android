...
(function(){
  var A=window.LPOS;
  if(!A||!A.state)return;
  var S=A.state,nativeState='',localState='';
  ...
  S.meta=S.meta||{};
  S.meta.commercialBootstrap='UNCONFIGURED';
  ...
  S.scope={tenantId:null,workspaceId:null,venueId:null,branchId:null};
  S.tenants=[];S.workspaces=[];S.venues=[];S.branches=[];
  ...
  S.rates={ps5Solo:0,ps5Duo:0,sim:0,billiardGame:0};
  S.resources=[];S.stations=[];S.zones=[];S.products=[];
